...
const Body_div3_ProfileReport = () => {
  ...
  return (
    <div className="w-full h-48  p-6 bg-white dark:bg-background   rounded-lg shadow-md ml-6">
      <div className="flex flex-col ">
        <div className="flex justify-between items-start ">
          <div>
            <h3 className="text-lg font-medium text-gray-700 dark:bg-background   mb-2">
              Profile Report
            </h3>
